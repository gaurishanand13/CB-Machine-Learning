...
class QuotesSpider(scrapy.Spider):
    ...
    name = "quotes" #It is the name of the spider. Therefore it must be unique within a project. This name will be only used to run from the terminal
...
#For running the above spider, run the command scrapy crawly spider_name i. in this case 'quotes'
