...
#Generally while writing the csv file, we use this. Because it organises it well and makes writing very easy
import csv
...
class scrappingBookWebSite(scrapy.Spider):
    ...
    def __init__(self):
        with open("books.csv",'a') as csvFile:
            ...
            writer.writerow(['image_url','book_title','product_price'])
